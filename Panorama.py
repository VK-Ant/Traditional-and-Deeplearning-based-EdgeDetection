...
#
# image_paths = glob.glob("/home/vk/Desktop/panaroma/images/desktop/*.jpg")
# images = []
#
...
# if not error:
#
#     cv2.imwrite("stichedoutputimage.png",stitched_img)
#     cv2.imshow("stiched_Image", stitched_img)
#     cv2.waitKey(0)
...
image_paths = glob.glob('images/desktop/*.jpg')
images = []
